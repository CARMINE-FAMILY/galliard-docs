...
export default function UnixActions() {
  ...
  return (
    <div className="container doc-content">
      ...
      <p className="text">
        Array de zonas horarias soportadas (<span className="inline-code">as const</span>).
        Se usa para tipar <span className="inline-code">SupportedTimeZone</span> y
        limitar qué timezones son válidos en las demás funciones.
      </p>
      <DataTable
    ...
    'UTC'
      ...
      <p className="text">
        ...
        <span className="inline-code">Date</span>) a timestamp Unix en
        segundos (UTC).
      </p>
      ...
      <p className="text">
        ...
        segundos. Si <span className="inline-code">dateString</span> es
        falsy, retorna <span className="inline-code">0</span>.
      </p>
      <CodeBlockGal
        hideHeaderIfSingleTab
        tabs={[
...
unixToDate(1783936800, "Europe/Madrid")`,
      ...
      <p className="text">
        Convierte un timestamp Unix a un string legible en español, con hora
        en formato 12h y AM/PM.
      </p>
      <h3 className="subtitle">Parámetros</h3>
      <DataTable
        columns={propsColumns}
      ...
      <p className="text">
        Convierte un timestamp Unix únicamente a la parte de fecha (sin
        hora), usando el mismo formato que{" "}
